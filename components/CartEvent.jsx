  ...
  return (
    <div className="col-span-1 max-w-[350px] max-h-[410px] p-4 max-sm:p-2 rounded-lg bg-white relative max-[440px]:max-w-[100%] max-[440px]:p-4 max-[440px]:max-h-auto">
      ...
      <div className="flex justify-between items-center mt-3">
        <Link href={`/page/${id}`} className="bg-[#a6a6a6] px-6 py-2 rounded-md w-fit text-white cursor-pointer max-[1521px]:py-1 max-[1521px]:px-4 max-[440px]:px-6 max-[440px]:py-2">
          <p>รายละเอียด</p>
        </Link>
